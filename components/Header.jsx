...
const Header = () => {
    ...
    return (
    <header className={`w-full h-[50px] md:h-[80px] bg-white-flex items-center justify-between z-20 sticky top-3 transition-transform duration-300 ${show}`}>
        <Wrapper className="h-[60px] flex justify-between items-center">
            ...
            <div className='flex items-center gap-2 text-black'>
                ...
                items-center hover:bg-black/[0.05] cursor-pointer relative'>
                    ...
                    <div className='h-[14px] md:[18px] min-w-[14px] md:min-w-[18px]
